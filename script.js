        ...
        input.onchange = function(e) {
            ...
            reader.onload = function(event) {
                try {
                    ...
                    document.getElementById('rappSourceStatus').textContent = `✅ ${Rapprochement.donneesSource.length} lignes`;
        ...
        input.onchange = function(e) {
            ...
            reader.onload = function(event) {
                try {
                    ...
                    document.getElementById('rappCompareStatus').textContent = `✅ ${Rapprochement.donneesCompare.length} lignes`;
