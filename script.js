...
// ============================================================
// SECTION ZACC - Version simplifiée (filtrage direct sur Sens)
// ============================================================
...
const ZACC = {
    ...
    appliquerFiltres: function() {
        ...
        // عرض قيم Sens الموجودة
        var sensValues = {};
        this.donnees.forEach(function(d) {
            var sens = String(d['Sens'] || 'non_defini').trim();
            sensValues[sens] = (sensValues[sens] || 0) + 1;
        });
        console.log('📊 Valeurs de "Sens" dans les données:', sensValues);
        ...
        console.log('  - croissant:', resultatsCroissant.length, 'zones');
        console.log('  - decroissant:', resultatsDecroissant.length, 'zones');
