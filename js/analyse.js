...
// ============================================================
// 4. GÉNÉRER LES POINTS PK (3 NIVEAUX)
// ============================================================
...
function genererPointsPK(container, donnees, showTues, showBG, showBL, sens) {
    ...
    const baseTop = estCroissant ? 30 : 70; // 30% pour croissant, 70% pour décroissant
    ...
    Object.keys(pointsParPK).forEach(pkStr => {
        ...
        // Répartir les accidents sur 3 niveaux
        accidents.forEach((d, index) => {
            const niveau = index % 3; // 0, 1, 2
            const decalage = (niveau - 1) * 12; // -12, 0, 12
